...
func TestGetPendingCases(t *testing.T) {
	...
	assert.Equal(sirius.Criteria{}.Filter("status", "Pending").Page(1).Sort("workedDate", sirius.Descending), client.casesByAssignee.lastCriteria)
...
func TestGetPendingCasesPage(t *testing.T) {
	...
	assert.Equal(getContext(r), client.casesByAssignee.lastCtx)
	assert.Equal(14, client.casesByAssignee.lastId)
	assert.Equal(sirius.Criteria{}.Filter("status", "Pending").Page(4).Sort("workedDate", sirius.Descending), client.casesByAssignee.lastCriteria)
